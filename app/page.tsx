    ...
    <div className="py-8 sm:py-12">
        ...
        <div className="mt-6 space-y-6">
          <div>
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              <h3 className="text-lg font-medium">Software Engineer · AtlasNova AI</h3>
              <span className="text-sm text-gray-500">Feb 2025 – Present · Cupertino, US</span>
            </div>
            <ul className="list-disc ms-5 mt-2 text-sm leading-6">
              <li>Frontend development with JavaScript, TypeScript, React, Next.js, and Tailwind CSS.</li>
              <li>Backend development with JavaScript, Python, Express.js, RESTful APIs, DynamoDB, AWS, and Docker.</li>
            </ul>
          </div>

          <div>
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              <h3 className="text-lg font-medium">Data Analyst · Huaxia Bank & Hengfeng Bank</h3>
              <span className="text-sm text-gray-500">Aug 2015 – Jul 2023 · Beijing, CN</span>
            </div>
            <ul className="list-disc ms-5 mt-2 text-sm leading-6">
              <li>Executed data querying and extraction using SQL.</li>
              <li>Applied statistical methods and machine learning algorithms for data analysis using Python.</li>
          ...
          <div>
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              <h3 className="text-lg font-medium">Research Assistant · University of Amsterdam</h3>
              <span className="text-sm text-gray-500">Sep 2011 – Sep 2014 · Amsterdam, NL</span>
            </div>
            <ul className="list-disc ms-5 mt-2 text-sm leading-6">
              <li>Researched risk manipulation and market performance using MATLAB.</li>
      ...
      <section id="education" className="mb-12">
        ...
        <div className="mt-6 space-y-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <p className="text-sm"><span className="font-medium">Master of Science in Economics</span> · University of Amsterdam, Amsterdam, Netherlands</p>
            <span className="text-sm text-gray-500">Sep 2009 – Aug 2011</span>
          </div>
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <p className="text-sm"><span className="font-medium">Bachelor in Statistics</span> · Huazhong University of Science and Technology, Wuhan, China</p>
        ...
        <div className="mt-6 grid sm:grid-cols-2 gap-6">
          <article className="card p-5 transition-shadow hover:shadow-md">
            ...
            <ul className="list-disc ms-5 mt-2 text-sm leading-6">
              ...
              <li>Built frontend components including landing page, application interface, and admin panel using React and Next.js.</li>
              <li>Implemented backend services using JavaScript and Python, integrating with Stripe, Uber Eats, Google, Instagram, and other APIs.</li>
              <li>Constructed data pipelines for analytics visualization and implemented LLM-powered suggestion features.</li>
              <li>Automated deployment processes using GitHub Actions and AWS infrastructure.</li>
            </ul>
          </article>
          ...
          <article className="card p-5 transition-shadow hover:shadow-md">
            ...
            <ul className="list-disc ms-5 mt-2 text-sm leading-6">
              ...
              <li>Developed the frontend using React, JavaScript, HTML, and CSS, and connected the backend with RESTful APIs to external services.</li>
          ...
          <article className="card p-5 transition-shadow hover:shadow-md sm:col-span-2">
            ...
            <ul className="list-disc ms-5 mt-2 text-sm leading-6">
              ...
              <li>Implemented in Python and Shell, using PyTorch and the Hugging Face Transformers library.</li>
            </ul>
          </article>
        </div>
      </section>
      ...
      <section id="contact" className="mb-4">
        ...
        <p className="mt-3 text-sm leading-6">
          Email: <a href="mailto:lt.zhou1119@gmail.com" className="underline">lt.zhou1119@gmail.com</a>
          <br />
          Phone: 672-966-1119
          <br />
          ...
          <a
            ...
            className="underline"
          >
            linkedin.com/in/liting-zhou-8678b687/
          </a>
        </p>
      </section>
    </div>
